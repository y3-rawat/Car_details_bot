...
#     // Loop through the dynamic data and create content sections
#     data.forEach(function(item) {
#         if (item.includes('**')) {
#             // Add bold styling or separator line before sections with "**" characters
#             botResponse += '<div class="responseSection">' +
#                                 '<hr />' +
#                                 '<div class="contentTitle">' + item.replace(/\*\*/g, '') + '</div>' +
#                             '</div>';
#         } else {
#             botResponse += '<div class="responseSection">' +
#                                 '<div class="contentDescription">' + item + '</div>' +
#                             '</div>';
#         }
#     });
